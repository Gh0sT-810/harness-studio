...
class ArtifactClient:
    ...
    def save_bytes(self, scope: str, artifact_type: str, filename: str, content: bytes, metadata: dict, content_type: str) -> dict:
        boundary = "----harness-report-artifact-boundary"
